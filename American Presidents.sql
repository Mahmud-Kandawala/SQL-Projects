...
wars varchar(80),
PRIMARY KEY (presidentialNumber)
);
...
select presidentialNumber as "Presidential Number", concat(firstName, ' ', lastName) as "Name", party as " Other Parties"  from presidentData where party <> "Republican" and party <> "Democrat";
...
select presidentialNumber as "Presidential Number", concat(firstName, ' ', lastName) as "Name", terms as "Served One Term" from presidentData where terms = "1";


-- Q7 = Display all presidents that served 2 terms. (first, last & terms)
select presidentialNumber as "Presidential Number", concat(firstName, ' ', lastName) as "Name", terms as "Served Two Terms" from presidentData where terms = "2";


-- Q8 = Display all presidents that served more than 2 terms. (first, last & terms)
select presidentialNumber as "Presidential Number", concat(firstName, ' ', lastName) as "Name", terms as " Served More Than 2 Terms" from presidentData where terms > "2";
